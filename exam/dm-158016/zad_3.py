...
# przygotuj pakiet pliki(ma być możliwość wczytania wszystkiego za pomocą from pliki import * )
# z modułem zapisy a w nim funkcję wczytaj
# powinna przyjmować jeden argument, którym jest ścieżka do pliku
# ma go otworzyć i wczytać dane generując słownik ze współrzędnymi
# dla obiektów w grze: { robaczek: {x:, y:}, owoce: [ {x:,y:, jedzenie:, nazwa:}..... ]}
